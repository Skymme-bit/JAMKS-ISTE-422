...
// Logger: Main class for handling related functionality
// Logger: This class defines the core functionality for logger service.
class Logger {
  ...
  private log(logType: ILoggerBody, level: string, logKeyPairs?: {}): void {
    ...
    const logMessage = `[time]=${this.timeStamp()} [level]=${level} [message]='${
      ...
      logType.path
    } [execution_time]=${this.executionTime()}ms`;
